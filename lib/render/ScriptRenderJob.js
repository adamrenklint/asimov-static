...
module.exports = Base.extend({
  ...
  'run': function (model) {
    ...
    var browserifyCommand = npath.join(self.options.frameworkDir, 'node_modules/browserify/bin/cmd.js -t ' + self.options.frameworkDir + 'node_modules/babelify ' + attributes.path + ' > ' + outPath);
